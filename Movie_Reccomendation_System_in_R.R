...
#Retrieving data
movie_data <- read.csv("C:/Users/master/OneDrive/Desktop/R P2/movies.csv", stringsAsFactors = FALSE)
rating_data <- read.csv("C:/Users/master/OneDrive/Desktop/R P2/ratings.csv")
